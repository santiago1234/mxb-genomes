...
ggsave("plots/sfs-missense-folded.pdf", height = 7, width = 8)
ggsave("plots/sfs-missense-folded.png", height = 7, width = 8)
...
ggsave("plots/sfs-synonymous-folded.pdf", height = 7, width = 8)
ggsave("plots/sfs-synonymous-folded.png", height = 7, width = 8)
...
ggsave("plots/sfs-lof-folded.pdf", height = 7, width = 8)
ggsave("plots/sfs-lof-folded.png", height = 7, width = 8)
...
general %>% 
  ...
  labs(
    y = "log10  Proportion",
    title = "SFS shape in different populations",
    x = "Minor allel frequency"
  ) +
  theme(
    legend.position = "bottom",
    panel.grid.minor = element_blank()
  )
ggsave("plots/sfs-Pops-folded.pdf", height = 4, width = 7.5)
ggsave("plots/sfs-Pops-folded.png", height = 4, width = 7.5)
