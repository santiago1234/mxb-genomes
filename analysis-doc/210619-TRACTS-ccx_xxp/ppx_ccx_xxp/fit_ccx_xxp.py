...
startparams = [
    0.2,  # The arriving fraction of European migrants in the very first generation
    0.04,  # frac1
    0.04,  # frac2
    0.16,  # t1
    0.06,  # frac3
...
opt = tracts.optimize_cob_fracs2(startparams,bins,Ls,data,nind,func,props,outofbounds_fun=bound,cutoff=cutoff,epsilon=1e-2)
