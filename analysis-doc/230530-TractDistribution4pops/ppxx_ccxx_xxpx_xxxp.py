...
The order of the populations is NAT, EUR, and AFR.
"""
import numpy


# testing parameters
params = [[0.2, 0.4, 0.4, 0.16, 0.06, 0.04, 0.11, 0.08]]

def ppxx_ccxx_xxpx_xxxp(*params):
    ...
    (initEu_frac, frac1, frac2, t1, frac3, frac4, t2, t3) = params[0]
    t1 *= 100
    t2 *= 100
    t3 *= 100
...
def outofbounds_ppxx_ccxx_xxpx_xxxp(*params):
