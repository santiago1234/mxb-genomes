...
rule collect_xgmix_output:
    ...
    output:
        ...
        rephased_vcf = "results/data/210308-local-ancestry/rephased-query-with-lai/query-chr{chrn}.vcf.gz"
    params:
        ...
        xrephase_vcf = "results/data/210308-local-ancestry/mdl-{chrn}/query_file_phased.vcf"
    shell:
        """
