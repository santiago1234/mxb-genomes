...
rule download_GRCh38_genome:
    ...
    output:
        temp("results/data/210301-lifted_to_GRCh38/GRCh38.primary_assembly.genome.fa")
    shell:
        """
        wget ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_37/GRCh38.primary_assembly.genome.fa.gz
        gunzip GRCh38.primary_assembly.genome.fa.gz
        mv GRCh38.primary_assembly.genome.fa results/data/210301-lifted_to_GRCh38/
        """
...
rule download_ucsc_chain_hg19ToHg38:
    ...
    output:
        temp("results/data/210301-lifted_to_GRCh38/hg19ToHg38.over.chain.gz")
    shell:
        """
        wget http://hgdownload.soe.ucsc.edu/goldenPath/hg19/liftOver/hg19ToHg38.over.chain.gz
        mv hg19ToHg38.over.chain.gz results/data/210301-lifted_to_GRCh38/
        """
...
rule lift_over_to_GRCh38:
    input:
        ...
        chain_file = "results/data/210301-lifted_to_GRCh38/hg19ToHg38.over.chain.gz",
        GRCh38_genome = "results/data/210301-lifted_to_GRCh38/GRCh38.primary_assembly.genome.fa"
    output:
        temp("results/data/210301-lifted_to_GRCh38/mxb-ALL-GRCh38.vcf"),
    ...
    params:
        ...
        vcf_uncompressed = "results/data/210301-lifted_to_GRCh38/mxb-ALL-GRCh37.vcf"
    shell:
        """
...
rule sort_lifted_and_index:
    input:
        "results/data/210301-lifted_to_GRCh38/mxb-ALL-GRCh38.vcf"
    output:
        "results/data/210301-lifted_to_GRCh38/mxb-ALL-GRCh38-sorted.vcf.gz",
        "results/data/210301-lifted_to_GRCh38/mxb-ALL-GRCh38-sorted.vcf.gz.tbi"
    shell:
        """
