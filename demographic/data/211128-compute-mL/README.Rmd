...
In these notes, I will show the procedure to get $mL$ for the intronic genome.
...
Also, there 32 3-mers. We have half because each sequence represents the sequence and its complement. For example, *TCA* represents *TCA* and *AGT*.
